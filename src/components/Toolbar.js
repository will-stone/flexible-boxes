          ...
          { /* Only show toolbar if box is selected */
            thisBox ?
              <div className="Toolbar__tools">
                ...
                )}>Affects child boxes</h2>

                <div className="Toolbar__section">
                  <h3 className={classnames({ 'Toolbar__disabled': !thisBox.c })}>Flow</h3>
                  <div className="Toolbar__splitSection">
                    <div>
                      <h4 className={classnames({ 'Toolbar__disabled': !thisBox.c })}>Direction</h4>
                    ...
                    <div>
                      <h4 className={classnames({ 'Toolbar__disabled': !thisBox.c })}>Wrap</h4>
                      <label className="Toolbar__iconRadioLabel">
                        <input
                          type="radio"
                          name="w"
                ...
                <div className="Toolbar__section">
                  <h3 className={classnames({ 'Toolbar__disabled': !thisBox.c })}>Justify Content</h3>
                  <label className="Toolbar__iconRadioLabel">
                    <input
                      type="radio"
                      name="jc"
                ...
                <div className="Toolbar__section">
                  <h3 className={classnames({ 'Toolbar__disabled': !thisBox.c })}>Align Items</h3>
                ...
                <div className="Toolbar__section">
                  ...
                  <div className="Toolbar__splitSection">
                    <div className={classnames(
                      { 'Toolbar__default': !thisBox.g }
                    )}>
                      <h4>GROW</h4>
                      <div>
                        <button className="Toolbar__nudgeButton" onClick={this.props.nudge.bind(this, this.props.id, 'g', thisBox.g ? thisBox.g - 1 : 0)}><i className="fa fa-minus"></i></button>
                        <span className="Toolbar__nudgeText">{thisBox.g ? thisBox.g : 0}</span>
                        <button className="Toolbar__nudgeButton" onClick={this.props.nudge.bind(this, this.props.id, 'g', thisBox.g ? thisBox.g + 1 : 1)}><i className="fa fa-plus"></i></button>
                      </div>
                    </div>
                    ...
                    <div className={classnames(
                      ...
                      <h4>SHRINK</h4>
                      <div>
                        <button className="Toolbar__nudgeButton" onClick={this.props.nudge.bind(this, this.props.id, 's', thisBox.s ? thisBox.s - 1 : 0)}><i className="fa fa-minus"></i></button>
                        <span className="Toolbar__nudgeText">{thisBox.s || thisBox.s === 0 ? thisBox.s : 1}</span>
                        <button className="Toolbar__nudgeButton" onClick={this.props.nudge.bind(this, this.props.id, 's', thisBox.s || thisBox.s === 0 ? thisBox.s + 1 : 2)}><i className="fa fa-plus"></i></button>
                      </div>
                    </div>

                    <div className={classnames(
                      { 'Toolbar__default': !thisBox.b }
                    )}>
                      <h4>BASIS</h4>
                      <input
