      ...
      <div className="Dom Pane__component">
        ...
        </ul>
        {
          ...
          <div className="Dom__boxReorderButtons">
            ...
            )} onClick={this.props.moveBox.bind(this, 'up')}>UP</button>
            <button className={classnames(
              'button',
              { 'Dom__boxReorderButton--isDisabled': selectedBoxId === boxes[1].c[boxes[1].c.length - 1] }
            )} onClick={this.props.moveBox.bind(this, 'down')}>DOWN</button>
          </div>
        }
      </div>
    );
