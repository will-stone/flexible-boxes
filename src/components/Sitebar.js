    ...
    return (
      <div className="Sitebar">
        ...
        <div className="Sitebar__actions">
          ...
          <a className="Sitebar__button button" href="#~(1~(c~(~2~3~4)~t~'body~d~'column)~2~(t~'header)~3~(g~1~c~(~5~6~7))~4~(t~'footer)~5~(t~'sidebar)~6~(t~'main~g~1)~7~(t~'sidebar))" onClick={() => selectBox(null)}>HOLY GRAIL</a>
        </div>
